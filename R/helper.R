...
#' @param wider,taller A single numeric value indicating how many inches to add to the output plot width/height. Default makes a 5"x7" image.
...
save_figure = function(gg, out_path, wider = 0, taller = 0, quality = "high", ...) {
